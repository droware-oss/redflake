use clap::Parser;
use redflake::snowflake::SnowflakeGenerator;
...
async fn main() {
    ...
    let generator = Arc::new(SnowflakeGenerator::new(args.machine));
    ...
    tokio::select! {
        ...
        _ = async {
            loop {
                ...
                let mut handler = Handler::new(socket, addr, generator.clone(),
                    closing_tx.subscribe(), conn_closed_tx.clone());
